  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="relative">
        <div className="mx-auto flex w-11/12 max-w-[1280px] flex-col items-center justify-between gap-8 px-4 py-section lg:flex-row lg:gap-4">
          <Reveal direction="right" className="w-full lg:w-6/12">
