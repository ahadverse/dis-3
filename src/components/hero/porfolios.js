        ...
        <div className='w-full sm:w-10/12 md:w-8/12'>
          <Reveal>
            <h1 className='font-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-center text-text-primary font-bold leading-tight sm:leading-loose'>
              Our Projects that reflects <br className='hidden sm:block' />{" "}
              Our Commitment
            </h1>
          </Reveal>
          ...
          <Reveal delay={0.1}>
            <p className='mt-6 text-base sm:text-lg md:text-xl text-center leading-relaxed text-text-secondary'>
              Our web development service projects are like our promises made
              real—each one special and filled with hard work and care.
            </p>
          </Reveal>

          <Reveal delay={0.12}>
            <p className='mx-auto mt-4 max-w-2xl text-center text-base text-text-secondary'>
              Every project below started the same way every client project
              starts — a conversation about what the business actually needs,
              not a template we try to force a brand into. Browse a few, and
              read on below for how we approach the work behind each one.
            </p>
          </Reveal>
